    ...
    <FlatList   
        ...
        renderItem={({item}) => (
            <View className="flex-row items-center justify-between">
                <TouchableOpacity disabled={!origin} className="p-2 pl-6 pb-4 pt-4 bg-gray-200 m-3.5 w-40 rounded-md" onPress={() => navigation.navigate(item.screen)}>
                    <View className={!origin && "opacity-50"}>
